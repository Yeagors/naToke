            ...
            <div class="lg:col-span-1 flex flex-col gap-6">
                ...
                <div class="glass rounded-2xl p-6">
                    <form method="POST" action="{{ route('cars.update', $car) }}" enctype="multipart/form-data" id="car-photo-form">
                        ...
                        <input type="hidden" name="frame_number" value="{{ $car->frame_number }}">
                    ...
                    <fieldset class="rounded-xl border border-white/8 px-4 py-3">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-2">
                            <div>
                                ...
                                <x-text-input id="frame_number" type="text" name="frame_number" :value="old('frame_number', $car->frame_number)" maxlength="100" placeholder="напр. JL20250500125" />
                                <x-input-error :messages="$errors->get('frame_number')" />
                            </div>
                            <div>
                                <x-input-label for="battery_capacity" :value="'Ёмкость аккумулятора'" />
                                <x-text-input id="battery_capacity" type="text" name="battery_capacity" :value="old('battery_capacity', $car->battery_capacity)" maxlength="50" placeholder="напр. 60/45" />
